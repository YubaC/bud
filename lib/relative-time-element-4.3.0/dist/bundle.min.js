    ...
    constructor(locale, options = {}) {
        ...
        __classPrivateFieldSet(
            ...
            _DurationFormat_options,
            {
                ...
                minutes,
                minutesDisplay:
                    options.minutesDisplay === 'always' ? 'always' : style === 'digital' ? 'always' : 'auto',
                seconds,
                secondsDisplay:
                    options.secondsDisplay === 'always' ? 'always' : style === 'digital' ? 'always' : 'auto',
                milliseconds,
...
var Duration = class {
    ...
    static from(durationLike) {
        ...
        if (typeof durationLike === 'string') {
            ...
            const parsed =
                (_a = str.match(durationRe)) === null || _a === void 0
                    ? void 0
...
function roundToSingleUnit(duration, {relativeTo = Date.now()} = {}) {
    ...
    if (milliseconds >= 900) seconds += Math.round(milliseconds / 1e3)
...
function getUnitFactor(el) {
    ...
    if (ms < 60 * 1e3) return 1e3
    if (ms < 60 * 60 * 1e3) return 60 * 1e3
    return 60 * 60 * 1e3
}
...
var RelativeTimeElement = class extends HTMLElement {
    constructor() {
        ...
        _RelativeTimeElement_renderRoot.set(
            this,
            this.shadowRoot ? this.shadowRoot : this.attachShadow ? this.attachShadow({mode: 'open'}) : this,
        )
    ...
    set onRelativeTimeUpdated(listener) {
        if (__classPrivateFieldGet2(this, _RelativeTimeElement_onRelativeTimeUpdated, 'f')) {
            this.removeEventListener(
                ...
                __classPrivateFieldGet2(this, _RelativeTimeElement_onRelativeTimeUpdated, 'f'),
            )
        }
        __classPrivateFieldSet2(
            this,
            _RelativeTimeElement_onRelativeTimeUpdated,
            typeof listener === 'object' || typeof listener === 'function' ? listener : null,
            'f',
        )
    ...
    get year() {
        ...
        if (
            ...
            /* @__PURE__ */ new Date().getUTCFullYear() !==
                ((_a = this.date) === null || _a === void 0 ? void 0 : _a.getUTCFullYear())
        ) {
            return 'numeric'
        }
    }
    ...
    attributeChangedCallback(attrName, oldValue, newValue) {
        ...
        if (
            ...
            !(attrName === 'title' && __classPrivateFieldGet2(this, _RelativeTimeElement_customTitle, 'f'))
        ) {
            __classPrivateFieldSet2(
                this,
    ...
    update() {
        ...
        if (newText) {
            ...
            this.shadowRoot === __classPrivateFieldGet2(this, _RelativeTimeElement_renderRoot, 'f') &&
            this.textContent
        ) {
            __classPrivateFieldGet2(this, _RelativeTimeElement_renderRoot, 'f').textContent = this.textContent
        }
...
;(_RelativeTimeElement_customTitle = /* @__PURE__ */ new WeakMap()),
    ...
    (_RelativeTimeElement_lang_get = /* @__PURE__ */ __name(function _RelativeTimeElement_lang_get2() {
        var _a
        return (
            ((_a = this.closest('[lang]')) === null || _a === void 0 ? void 0 : _a.getAttribute('lang')) ||
            this.ownerDocument.documentElement.getAttribute('lang') ||
            'default'
        )
    }, '_RelativeTimeElement_lang_get')),
    (_RelativeTimeElement_getFormattedTitle = /* @__PURE__ */ __name(function _RelativeTimeElement_getFormattedTitle2(
        date,
    ) {
        return new Intl.DateTimeFormat(
            __classPrivateFieldGet2(this, _RelativeTimeElement_instances, 'a', _RelativeTimeElement_lang_get),
            {
                day: 'numeric',
                month: 'short',
                year: 'numeric',
    ...
    '_RelativeTimeElement_getFormattedTitle')),
    (_RelativeTimeElement_resolveFormat = /* @__PURE__ */ __name(function _RelativeTimeElement_resolveFormat2(
        duration,
    ) {
        const format = this.format
        if (format === 'datetime') return 'datetime'
    ...
    '_RelativeTimeElement_resolveFormat')),
    (_RelativeTimeElement_getDurationFormat = /* @__PURE__ */ __name(function _RelativeTimeElement_getDurationFormat2(
        duration,
    ) {
    ...
    '_RelativeTimeElement_getDurationFormat')),
    (_RelativeTimeElement_getRelativeFormat = /* @__PURE__ */ __name(function _RelativeTimeElement_getRelativeFormat2(
        duration,
    ) {
    ...
    '_RelativeTimeElement_getRelativeFormat')),
    (_RelativeTimeElement_getDateTimeFormat = /* @__PURE__ */ __name(function _RelativeTimeElement_getDateTimeFormat2(
        date,
    ) {
